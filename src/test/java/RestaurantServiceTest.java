...
class RestaurantServiceTest {
    ...
    private void createDummyOnlineRestaurantWithItems() {
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object() throws restaurantNotFoundException {
        ...
        createDummyOnlineRestaurantWithItems();
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() {
        //WRITE UNIT TEST CASE HERE
        createDummyOnlineRestaurantWithItems();
        String searchRestaurantName = "Amelie's club"; //Non-existent restaurant name

        assertNotNull(service.getRestaurants());
        assertThrows(restaurantNotFoundException.class,
                () -> service.findRestaurantByName(searchRestaurantName));
